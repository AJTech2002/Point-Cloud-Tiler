...
import pickle
import zmq
import py3dtiles.points.global_vars as globs
...
def init_parser(subparser, str2bool):
    ...
    parser.add_argument(
        '--subdivision_limit',
        help='Subdiv Limit (2000) and / Length', default=2000, type=int)
    parser.add_argument(
        '--length_limit',
        help='Length Limit in (m)', default=0.01, type=float)
    parser.add_argument(
        '--merge_limit',
        help='Merge Limit for Tiles (100)', default=100, type=int)
